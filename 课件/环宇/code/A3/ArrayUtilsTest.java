...
public class ArrayUtilsTest {
	...
	System.out.println("删除最后一个元素");
        int[] array4 = ArrayUtils.remove(array0, 4);// 删除索引为4的元素
        System.out.println("数组中的元素是：");
        System.out.println(Arrays.toString(array1));// 输出新数组中的全部元素
        System.out.println("删除元素8");
        int[] array5 = ArrayUtils.removeElement(array3, 8);// 删除元素2
        System.out.println("数组中的元素是：");
        System.out.println(Arrays.toString(array5));// 输出新数组中的全部元素
    }
}
