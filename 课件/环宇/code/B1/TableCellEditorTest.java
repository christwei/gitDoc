...
public class TableCellEditorTest
{
	...
	Object[][] tableData =
	{
		new Object[]{"李清照" , 29 , "女" , new ImageIcon("ico/3.gif")
			, new ImageIcon("ico/3.gif") , true},
		new Object[]{"苏格拉底", 56 , "男" , new ImageIcon("ico/1.gif")
			, new ImageIcon("ico/1.gif") , false},
		new Object[]{"李白", 35 , "男" , new ImageIcon("ico/4.gif")
			, new ImageIcon("ico/4.gif") , true},
		new Object[]{"弄玉", 18 , "女" , new ImageIcon("ico/2.gif")
			, new ImageIcon("ico/2.gif") , true},
		new Object[]{"虎头" , 2 , "男" , new ImageIcon("ico/5.gif")
			, new ImageIcon("ico/5.gif") , false}
	};
	// 定义一维数据作为列标题
